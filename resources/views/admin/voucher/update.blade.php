...
<div id="layoutSidenav_content">
    ...
    <div class="container-fluid px-4">
        ...
        <li class="breadcrumb-item"><a href="{{ asset('voucher/list') }}">Voucher List</a></li>
        ...
        <div class="container-fluid px-1 py-5 mx-auto">
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    <form method="POST" action="{{action('\App\Http\Controllers\MembershipController@updateVoucher',1)}}" class="form-card" enctype="multipart/form-data">
                        @csrf
