<style>
    ...
    *:focus {
    ...
    .login .container .login-form form button[type=submit] {
        background: -webkit-linear-gradient(110deg, #EFDDB8 0%, #EFDDB8 100%);
        background: -o-linear-gradient(110deg, #EFDDB8 0%, #EFDDB8 100%);
        background: linear-gradient(-20deg, #EFDDB8 0%, #EFDDB8 100%);
        border: none;
        margin-top: 124px;
        margin-bottom: 20px;
        width: 241px;
    ...
    .login .container .login-form form button[type=submit]::after {
        ...
        background: -webkit-gradient(linear, left bottom, left top, from(#BFB193), to(#BFB193));
        background: -webkit-linear-gradient(bottom, #BFB193 0%, #BFB193 100%);
        background: -o-linear-gradient(bottom, #BFB193 0%, #BFB193 100%);
        background: linear-gradient(to top, #BFB193 0%, #BFB193 100%);
    }
