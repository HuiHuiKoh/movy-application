...
<div class="panel panel-default">
    <h1 class="text-center shadow-lg" style="font-size: 2rem; text-shadow: 2px 2px 4px #000000;">{{$forums->title}}</h1>
            ...
            <div class="card">
                ...
                <ul class="list-style-none">
                    ...
                    <li class="d-flex no-block card-body">
                        ...
                        <div>
                            <a href="{{action('\App\Http\Controllers\ForumController@reply',$thread->id)}}" class="m-b-0 font-medium p-0">
                                <h6>{{$thread->title}}</h6>
                            </a>
                        </div>
                        <div class="ml-auto">
                            <div class="tetx-right">
                                <h5 class="text-muted m-b-0">{{Carbon\Carbon::parse($thread->created_at)->format('d')}}</h5>
                                <span class="text-muted font-16">{{Carbon\Carbon::parse($thread->created_at)->format('M')}}</span>
                            </div>
                        </div>
                    </li>
                    @endforeach
